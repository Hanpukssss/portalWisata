...
<head>
    ...
    <title>Login Admin | Portal Wisata</title>
                ...
                <div class="card shadow-lg border-0">
                    <div class="card-body p-4">
                        <div class="text-center mb-3">
                            ...
                            <p class="text-muted mb-0">Masuk untuk mengelola data</p>
                        </div>
                        ...
                        <form method="POST" action="{{ route('admin.login.post') }}">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="email" name="email" class="form-control" placeholder="admin@local.test" required autofocus>
                            </div>
                            <div class="mb-3">
